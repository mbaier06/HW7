// Change the main event listener from DOMContentLoaded to firebase.auth().onAuthStateChanged
firebase.auth().onAuthStateChanged(async function(user) {
  ...
  if (user) {
    ...
    //Signed in Message & Sign out button
    document.querySelector('.sign-in-or-sign-out').innerHTML = `
    <div class="font-bold text-xl">Signed in as ${user.displayName}</div>
